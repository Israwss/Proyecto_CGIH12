...
glm::vec3 pointLightPositions[] = {
	glm::vec3(1.0f,  0.5f,  1.0f), // Esquina frontal derecha
	glm::vec3(1.0f,  0.5f, -1.0f), // Esquina trasera derecha
	glm::vec3(-1.0f,  0.5f,  1.0f), // Esquina frontal izquierda
	glm::vec3(-1.0f,  0.5f, -1.0f)  // Esquina trasera izquierda
};
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Ejercicios  mover luces puntuales a cada esquina, color distinto 
		// luz de reflector cambio color
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[0].linear"), 0.09f);     // Valor clave para alcance
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[0].quadratic"), 0.032f); // Valor clave para alcance

		// --- Point light 2 Roja ---
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].position"), pointLightPositions[1].x, pointLightPositions[1].y, pointLightPositions[1].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].ambient"), 0.05f, 0.0f, 0.0f);
		...
		// SpotLight Cian brillante
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), camera.GetPosition().x, camera.GetPosition().y, camera.GetPosition().z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), camera.GetFront().x, camera.GetFront().y, camera.GetFront().z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.0f, 0.0f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 3.0f, 0.0f, 0.0f); // Color Cian
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.specular"), 0.0f, 1.0f, 1.0f);
