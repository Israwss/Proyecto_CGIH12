...
int main() {
	...
	// Set up vertex data (and buffer(s)) and attribute pointers posicion y color 3 y 3
	float vertices[] = {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glPointSize(10); //tamaño punto
		//glDrawArrays(GL_POINTS,0,4); //a partir de donde y el numero de puntos que tomara
        

		//3 en una solo linea dos paralelas
        //glDrawArrays(GL_LINES,0,4); // a partir del vertice cero, dos puntos
		/*3  0
        2  1*/
