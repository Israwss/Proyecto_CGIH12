...
//LUZ DOS
//segunda luz 
glm::vec3 lightPos2(-1.0f, 0.5f, 0.0f); // Posición inicial diferente
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.position"), lightPos2.x, lightPos2.y + movelightPos2, lightPos2.z);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.0f, 0.4f, 1.0f); // Luz rojiza para diferenciar
...
//LUZ 2
    ...
    if (keys[GLFW_KEY_I]) {
        movelightPos2 += 0.05f; // Sube
    }
    if (keys[GLFW_KEY_K]) {
        movelightPos2 -= 0.05f; // Baja
    }
